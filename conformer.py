%%writefile /kaggle/working/cvit/conformer.py
import torch
...
class Conformer(nn.Module):
    ...
    def forward(self, x,y):
        ...
        x_att=[]
        # pdb.set_trace()
        # stem stage [N, 3, 320, 20] -> [N, 64, 56, 56]
...
class LDELayer(nn.Module):
    ...
    def forward(self, list_x,list_y):
        lde_out=[]
        #lde_out, *_ = model.lde(list_x,list_y)
        ...
        for j in range(init_stage, fin_stage):
            ...
            #torchvision.utils.save_image(lde_out[0], 'lde_output.png')
